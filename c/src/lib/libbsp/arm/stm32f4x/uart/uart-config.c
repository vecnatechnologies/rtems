...
stm32_uart_driver_entry stm32f_uart_driver_table[NUM_PROCESSOR_NON_CONSOLE_UARTS] = {
  ...
  [0] .base_driver_info = {
    ...
    .tx_pin               = {STM32F_GOIO_PORTB, 6},
    .rx_pin               = {STM32F_GOIO_PORTB, 7},
...
/*
  ...
  [1] .base_driver_info = {
    ...
    .tx_pin           = {STM32F_GOIO_PORTD, 5},
    .rx_pin           = {STM32F_GOIO_PORTD, 6},
  ...
  [2] .base_driver_info = {
    ...
    .tx_pin           = {STM32F_GOIO_PORTD, 8},
    .rx_pin           = {STM32F_GOIO_PORTD, 9},
  ...
  //          UART4
    ...
    .tx_pin           = {STM32F_GOIO_PORTC, 10},
    .rx_pin           = {STM32F_GOIO_PORTC, 11},
  ...
  [4] .base_driver_info = {
    ...
    .tx_pin           = {STM32F_GOIO_PORTD, 2},
    .rx_pin           = {STM32F_GOIO_PORTC, 12},
